...
a.to_html("crypto7.htm", index= False)
a.to_html("crypto7.html", index= False)
html_file = a.to_html()
...
pdfkit.from_string('crypo7.html', 'crypo11PDF.pdf', configuration=config)
pdfkit.from_file('crypo7.html', 'crypo11PDF.pdf', configuration=config)